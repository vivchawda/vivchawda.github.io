...
- Examples (copy/paste checklist when adding a case study):
  ...
  5. Add a nav link in `index.html` (update header `.nav`).</content>
<parameter name="filePath">/Users/vivekchawda/Library/Mobile Documents/com~apple~CloudDocs/Portfolio/vivchawda.github.io/.github/copilot-instructions.md